              ...
              <div class="card-body">
                   ...
                   <div class="container">
                       <div class="row">
                           ...
                           <div class="col-md-4">
                              <div class="card">
                                  <div class="card-header">Add Tender</div>
                                  <div class="card-body">
                                  <form action="" method="POST">
                                  @csrf

                                  <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Tender Name</label>
                                  ...
                                  <table class="table table-bordered" style="width:100%">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>{{ $tender->tender }}</td>
                                           <td>
                                              <a href="{{ url('tender/edit/'.$tender->id) }}" class="btn btn-info">Edit</a>
